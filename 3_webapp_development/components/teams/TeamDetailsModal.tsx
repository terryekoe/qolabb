                ...
                {leaders.length === 0 && members.length > 0 && (
                  <div className="mt-8 p-6 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800 text-center">
                    ...
                    <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">
                      No Group Leader Selected
                    </h3>
                    <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
                      This group needs a leader to manage tasks and submit the final project.
                      Discuss with your team and select a leader.
                    </p>
            ...
            <div className="absolute inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center rounded-2xl">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
                  Are you sure you want to remove this member from the team? This action cannot be
                  undone.
                </p>
