            ...
            <div className="space-y-3 max-w-md mx-auto">
              ...
              <button
                onClick={() => {
                  ...
                  setNewTitle('Need help with...');
                  setNewContent('');
                }}
                className="w-full flex items-center gap-3 p-3 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border border-purple-200 dark:border-purple-800 rounded-lg hover:shadow-md transition-all group text-left"
              >
              ...
              <button
                onClick={() => {
                  setShowCreateModal(true);
                  setNewTitle('Project Update:');
                  setNewContent('');
                }}
                className="w-full flex items-center gap-3 p-3 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-800 rounded-lg hover:shadow-md transition-all group text-left"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 p-3 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg hover:shadow-md transition-all group text-left"
              >
