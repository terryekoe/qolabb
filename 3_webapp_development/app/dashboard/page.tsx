...
import { FolderKanban, Users, BarChart3, TrendingUp, Plus, Clock, ClipboardCheck } from 'lucide-react';
                    ...
                    <>
                      ...
                      {pendingEvaluations.length > 0 && (
                        <button 
                          ...
                          className="bg-white/10 hover:bg-white/20 backdrop-blur-sm rounded-lg p-4 text-left transition-colors group"
                        >
                          <ClipboardCheck className="mb-2 group-hover:scale-110 transition-transform" size={24} />
