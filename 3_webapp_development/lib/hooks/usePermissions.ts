...
export function usePermissions(): UsePermissionsReturn {
  ...
  const userRole: EnhancedUserRole = profile?.role ? mapLegacyRole(profile.role) : 'student';
