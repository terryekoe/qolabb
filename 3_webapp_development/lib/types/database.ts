...
export type TeamAssignmentAction =
  | 'join_request'
  | 'invitation_sent'
  | 'approved'
  | 'rejected'
...
export type TeamJoinRequestUpdate = Partial<
  Omit<
    TeamJoinRequest,
    'id' | 'team_id' | 'user_id' | 'requested_by' | 'request_type' | 'created_at' | 'updated_at'
  >
>;
export type ProjectUpdate = Partial<
  Omit<Project, 'id' | 'workspace_id' | 'team_id' | 'created_at' | 'updated_at'>
>;
export type TaskUpdate = Partial<Omit<Task, 'id' | 'project_id' | 'created_at' | 'updated_at'>>;
export type ContributionUpdate = Partial<
  Omit<Contribution, 'id' | 'project_id' | 'user_id' | 'created_at' | 'updated_at'>
>;
